...
class ClassicTerminal:
    ...
    def close(
        ...
        print("Closing Humecord. Goodbye!")
    ...
    def log(
        ...
        print(f"{self.color['secondary']}{self.line_count} | {colors.termcolors['reset']}{message}")
    ...
    def reprint(
        ...
        print("Deprecation warning: Reprint called when classic terminal was used. Report this!")
    ...
    async def ask(
        ...
        print("WIP warning: Logger ask() was called, but classic terminal is in use. Report this!")
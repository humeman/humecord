# I did not make this - it's shamelessly stolen from https://github.com/MrReacher/async-mcrcon.
# Sift through classes/console.py if you want to find out what it's for.

# Will almost definitely be deleted in a future update when I'm in less of a trolling mood.
